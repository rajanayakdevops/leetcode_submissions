...
//                 //marking the answer array 
                // here we are sure that the cell with  vlaue 1 is marked with the minimum distace, once the cell is marked first time we are marking the cell as visited right. so the same cell will never be updated again in future so that will be filled with min value only.....
